...
echo 'auto' > '/sys/bus/usb/devices/1-1.1.5/power/control';
echo 'auto' > '/sys/bus/usb/devices/1-1.1.4/power/control';
echo 'auto' > '/sys/bus/usb/devices/2-1.5/power/control';
echo 'auto' > '/sys/bus/usb/devices/1-1.1.6/power/control';
